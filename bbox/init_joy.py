...
- Publishing TF for camera tilt angle
"""
...
class JoyInit(Node):
    ...
    # Publish camera tilt TF (added)
    def publish_camera_tilt_tf(self):
        t = TransformStamped()

        t.header.stamp = self.get_clock().now().to_msg()
        t.header.frame_id = "camera_tilt"
